    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        @if (Auth::user()->position == 'Admin')
            ...
            {{-- <li class="nav-item">
              ...
              <ul id="customize-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                  <li>
                      <a href="{{ route('allPatients') }}"> 
                          <i class="bi bi-circle"></i><span>All Patients</span>
                      </a>
        ...
        @if (Auth::user()->position == 'Donar')
            <li class="nav-item">
                <a class="nav-link " href="{{ route('donar.dashboard') }}">
                    <i class="bi bi-grid"></i>
                    <span><h3>Donar Dashboard</h3></span>
                </a>
            </li><!-- End Dashboard Nav -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-journal-text"></i><span>Blood Request</span>
                    @if ($total_req > 0)
