        ...
        <div class="row content-ro">
            <div class="col-lg-4 col-md-12 footer-contact">
                ...
                <div class="address-row">
                    ...
                    <div class="detail">
                        <p>Support@donation.com <br>Helpme@donation.com</p>
                    </div>
                </div>
                <div class="address-row">
                    <div class="icon">
                    ...
                    <div class="detail">
                        <p>01579090000 <br> 01876543899</p>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-copy">
            <div class="row">
                <div class="col-lg-8 col-md-6">
                    <p>Copyright © <a href="https://www.smarteyeapps.com">moutusiislam.com</a> | All right
                        reserved.</p>
                </div>
